...
/* Additional structures for grid method. */
  Real ***kdata;		/* The transformed 1/r kernel. */
  Real **kspeq;		/* Rest of transformed 1/r kernel  */
  Real ***data;		/* The grid data. */
  Real ***data2;		/* reversed grid data. */
  Real **speq;			/* Storage for FFT. */
  Real **speq2;			/* Storage for FFT. */
  Real ***k2data; /* Hankel-like kernel  */ 
  Real **k2speq; 
  int   sizej, sizek, sizel;    /* Number of grid points in j,k and l dim. */
  double **colloc;		/* Collocation points for Q2G. */
  int csize;			/* number of collocation pts. */
  double ***invg2c;		/* Inverse of grid to collocation matrix. */
  int gridsize;			/* Number of gridpoints per cube edge.  */
  double ****g2g;		/* Grid to Grid matrices. */
  int minj, mink, minl; 
};
